        ...
        http //
                ...
                .authorizeHttpRequests(authorize -> //
                        authorize //
                                ...
                                // autorizzazioni per le operazioni crud degli invoice
                                .requestMatchers(HttpMethod.GET, "/api/invoices").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/invoices").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/invoices").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/invoices").hasAuthority("ADMIN")
                                /*non li valido perche si occupano solo di compilare i csv sul db*/
                                .requestMatchers(HttpMethod.POST,"api/invoiceStatus").hasAuthority("ADMIN")
